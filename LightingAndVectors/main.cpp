...
int main( )
{
    ...
    GLFWwindow* window = glfwCreateWindow( WIDTH, HEIGHT, "Assignment 5", nullptr, nullptr );
   ...
   //glfwSetInputMode( window, GLFW_CURSOR, GLFW_CURSOR_DISABLED );
    ...
    Shader lightingShader( "resources/shaders/light/lightingShader.vs", "resources/shaders/light/lightingShader.frag" );
    Shader lampShader( "resources/shaders/lamp/lampShader.vs", "resources/shaders/lamp/lampShader.frag" );
    ...
    */
    ...
    while ( !glfwWindowShouldClose( window ) )
    {
        ...
        glUniform3f( objectColorLoc, 0.3f, 0.6f, 0.31f );
       ...
       // glUniform3f( objectColorLoc, 0.3f, 0.6f, 0.31f );
        ...
        /*
            // set light position
        float lightX = 5.0f* lightX++;//sin(glfwGetTime());
            float lightY = 2.0f;
        float lightZ = 2.0f;//cos(glfwGetTime());
         ...
         // send model/light position to lamp shader
         lampShader.Use();
